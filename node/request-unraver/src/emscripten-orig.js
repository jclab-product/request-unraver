...
// end include: runtime_common.js
        ...
        function findWasmBinary() {
            return locateFile('quickjs-api.wasm');
        }
...
// Imports from the Wasm binary.
        var _js_init = Module['_js_init'] = makeInvalidEarlyAccess('_js_init');
        var _js_cleanup = Module['_js_cleanup'] = makeInvalidEarlyAccess('_js_cleanup');
        var _js_loop_step = Module['_js_loop_step'] = makeInvalidEarlyAccess('_js_loop_step');
        var _js_has_timers = Module['_js_has_timers'] = makeInvalidEarlyAccess('_js_has_timers');
        var _js_has_pending_jobs = Module['_js_has_pending_jobs'] = makeInvalidEarlyAccess('_js_has_pending_jobs');
        var _js_eval = Module['_js_eval'] = makeInvalidEarlyAccess('_js_eval');
        var _add = Module['_add'] = makeInvalidEarlyAccess('_add');
        var _multiply = Module['_multiply'] = makeInvalidEarlyAccess('_multiply');
        var _js_calculate = Module['_js_calculate'] = makeInvalidEarlyAccess('_js_calculate');
        var _js_free_string = Module['_js_free_string'] = makeInvalidEarlyAccess('_js_free_string');
        ...
        function assignWasmExports(wasmExports) {
            assert(typeof wasmExports['js_init'] != 'undefined', 'missing Wasm export: js_init');
            assert(typeof wasmExports['js_cleanup'] != 'undefined', 'missing Wasm export: js_cleanup');
            assert(typeof wasmExports['js_loop_step'] != 'undefined', 'missing Wasm export: js_loop_step');
            assert(typeof wasmExports['js_has_timers'] != 'undefined', 'missing Wasm export: js_has_timers');
            assert(typeof wasmExports['js_has_pending_jobs'] != 'undefined', 'missing Wasm export: js_has_pending_jobs');
            assert(typeof wasmExports['js_eval'] != 'undefined', 'missing Wasm export: js_eval');
            ...
            assert(typeof wasmExports['js_calculate'] != 'undefined', 'missing Wasm export: js_calculate');
            assert(typeof wasmExports['js_free_string'] != 'undefined', 'missing Wasm export: js_free_string');
            ...
            _js_init = Module['_js_init'] = createExportWrapper('js_init', 0);
            _js_cleanup = Module['_js_cleanup'] = createExportWrapper('js_cleanup', 0);
            _js_loop_step = Module['_js_loop_step'] = createExportWrapper('js_loop_step', 0);
            _js_has_timers = Module['_js_has_timers'] = createExportWrapper('js_has_timers', 0);
            _js_has_pending_jobs = Module['_js_has_pending_jobs'] = createExportWrapper('js_has_pending_jobs', 0);
            _js_eval = Module['_js_eval'] = createExportWrapper('js_eval', 1);
            _add = Module['_add'] = createExportWrapper('add', 2);
            _multiply = Module['_multiply'] = createExportWrapper('multiply', 2);
            _js_calculate = Module['_js_calculate'] = createExportWrapper('js_calculate', 1);
            _js_free_string = Module['_js_free_string'] = createExportWrapper('js_free_string', 1);
